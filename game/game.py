...
class Game:
    ...
    def add_cards(self, num: int):
        # lands
        self.players[num].lands.add_card(Card(groups=[self.sprite_group], name='Forest'))
        self.players[num].lands.add_card(Card(name='Forest'))
        self.players[num].lands.add_card(Card(name='Forest'))
        self.players[num].lands.add_card(Card(name='Forest'))
        self.players[num].lands.add_card(Card(name='Forest'))
        self.players[num].lands.add_card(Card(name='Island'))
        self.players[num].lands.add_card(Card(name='Island'))
        self.players[num].lands.add_card(Card(name='Island'))
        self.players[num].lands.add_card(Card(name='Island'))
        self.players[num].lands.add_card(Card(name='Island'))
        ...
        self.players[num].lands.add_card(Card(name='Island'))
        # battlefield
        self.players[num].battlefield.add_card(Card(name='Sun Titan'))
        self.players[num].battlefield.add_card(Card(name='Acidic Slime'))
        self.players[num].battlefield.add_card(Card(name='Ancient Den'))
        self.players[num].battlefield.add_card(Card(name='Banishing Light'))
        # hand
        self.players[num].hand.add_card(Card(name='Angel of the Ruins'))
        self.players[num].hand.add_card(Card(name='Arcane Denial'))
        self.players[num].hand.add_card(Card(name='Forest'))
        self.players[num].hand.add_card(Card(name='Island'))
        self.players[num].hand.add_card(Card(name='Cleansing Nova'))
        self.players[num].hand.add_card(Card(name='Coiling Oracle'))
        self.players[num].hand.add_card(Card(name='Doomskar'))
