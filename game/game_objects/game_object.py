...
class GameObject(pygame.sprite.Sprite):
    def __init__(self,
        ...
        self.rect.x = x if x is not None else self.game.screen.center[0] + self.rect.width // 2
        self.rect.y = y if y is not None else self.game.screen.center[1] + self.rect.height // 2
